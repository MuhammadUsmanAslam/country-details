...
# 📖 Country Details <a name="about-project"></a>

**Country Details** is an application where you can fetch countries data in a list format. When user clicks on a country 
...
```bash
git clone https://github.com/MuhammadUsmanAslam/country-details.git
```
...
- **List of Countries displayed on home page**
...
Orignal design was from <a href="https://www.behance.net/sakwadesignstudio">Nelson Sakwa</a>

I would also like to thank the <a href="https://stackoverflow.com/">stackoverflow</a> community whenever I got stuck into a problem or error got my solution there.
